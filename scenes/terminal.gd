...
func command_done(cmd):
	...
	if cmd.output.length() <= 1000:
		...
		game.notify("Questo e' il tuo terminale! Tutti i comandi vengono eseguiti qui e puoi vedere il loro output. Puoi anche digitare i tuoi comandi qui!", self, "terminal")
	else:
